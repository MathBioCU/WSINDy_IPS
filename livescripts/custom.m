...
diffpolys=[]; difftrigs=[0:2]; crossdrift=0;

%%% non-local operators
dim = size(Xscell{1},2)+1;
convargs = {{'dimx',dim-1,'utagin',1,'utagout',1,'psitags',1,'Mon',[1:3],'Sing',[-1 0],'Exp',[],'Singeps',[0.01],'svdtol',[1e-4]}};
...
tauhat_x = 4; tau_x = 10^-8;
p_x = []; mxs = 1;
tauhat_t = 1; tau_t = 10^-6;
p_t = []; mts = 1;
